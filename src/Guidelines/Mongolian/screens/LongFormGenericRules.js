        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <p class="block_137">Unintelligible or foreign or singing </p>
              <p class="block_138">
              ...
              <p class="block_141">Segmentation </p>
              <p class="block_142">
              ...
              <p class="block_145">Speaker labeling </p>
              <p class="block_146">
              ...
              <p class="block_156">Audio labels </p>
              <p class="block_157">
              ...
              <p class="block_189">
                registered U.S. and Canadian companies, commercial paper, and
              ...
              <p class="block_205">
                for diseases, signs and symptoms, abnormal findings, complaints,
