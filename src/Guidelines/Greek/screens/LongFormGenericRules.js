            ...
            <div className="content text">
              ...
              <div id="pii">
                ...
                <p className={styles.block_172}>
                  <span className={styles.text_4}>● </span>
                  <span className={styles.text_5}>CREDIT_CARD_NUMBER </span>
                </p>
                ...
                <p className={styles.block_174}>
                  <span className={styles.text_4}>● </span>
                  <span className={styles.text_5}>PHONE_NUMBER </span>
                </p>
                ...
                <p className={styles.block_176}>
                  <span className={styles.text_4}>● </span>
                  <span className={styles.text_5}>DRIVER_LICENSE_NUMBER </span>
                </p>
                ...
                <p className={styles.block_178}>
                  <span className={styles.text_4}>● </span>
                  <span className={styles.text_5}>SOCIAL_SECURITY_NUMBER </span>
                </p>
                <p className={styles.block_179}>
                  <span className={styles.text_4}>● </span>
                  <span className={styles.text_5}>PASSPORT </span>
                </p>
                ...
                <p className={styles.block_194}>
                  <span className={styles.text_4}>● </span>
                  <span className={styles.text_5}>MEDICARE_NUMBER </span>
                </p>
                ...
                <p className={styles.block_202}>
                  <span className={styles.text_4}>● </span>
                  <span className={styles.text_5}>TAXPAYER_REFERENCE </span>
                </p>
                ...
                <p className={styles.block_209}>
                  <span className={styles.text_2}>C</span>
                  <span className={styles.text_3}>ORRECT</span>
                  <span className={styles.text_2}>: Social media handles </span>
                </p>
              </div>
            </div>
          </Paper>
