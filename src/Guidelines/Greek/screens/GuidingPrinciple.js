        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <p class="block_101">Currency and unit </p>
              <p class="block_102">
              ...
              <p class="block_108">Date and time </p>
              <p class="block_109">
              ...
              <p class="block_127">Abbreviation </p>
              <p class="block_128">
