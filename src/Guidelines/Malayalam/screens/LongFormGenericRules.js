        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <p class="block_176">● MRN (medical record number)</p>
              <p class="block_187">
              ...
              <p class="block_189">● OHIP: Ontario Health Insurance Plan</p>
              <p class="block_190">
              ...
              <p class="block_197">● MEDICARE_NUMBER</p>
              <p class="block_198">
              ...
              <p class="block_208">Correct: Commonly known names like Taylor</p>
              <p class="block_209">Swift, Tom Hanks, Michael Jordan</p>
              <p class="block_210">Correct: Company or Business name, phone</p>
              <p class="block_211">number, or address.</p>
              <p class="block_212">Correct: Pet names</p>
              <p class="block_213">Correct: Social media handles</p>
            </div>
          </Paper>
        </Grid>
        <Hidden smDown>
