          ...
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <div id="typo">
                ...
                <p className={styles.block_193}>Correct: 卑怯</p>
                <p className={styles.block_194}>Incorrect: 卑却</p>
                <p className={styles.block_193}>Correct: 玷辱</p>
                <p className={styles.block_194}>Incorrect: 沾辱</p>
                <p className={styles.block_193}>Correct: 通缉</p>
                <p className={styles.block_194}>Incorrect: 通辑</p>
                <p className={styles.block_195}>Correct: 肖像</p>
                <p className={styles.block_194}>Incorrect: 肖象</p>
                ...
                <p className={styles.block_197}>
                  Correct: 提供各品牌平板电脑与周边配件。
                </p>
                <p className={styles.block_198}>
                  Incorrect: 提供各品牌平版电脑与周边配件。
                </p>
                <p className={styles.block_199}>Correct: 抱歉,再等一下。</p>
                <p className={styles.block_200}>Incorrect: 抱歉,在等一下。</p>
                <p className={styles.block_201}>
                  Correct: Check me on Facebook.
                </p>
                <p className={styles.block_74}>
                  Incorrect: Check me on Facebok.
                </p>
                <p className={styles.block_202}>
                  For English: Use the proper capitalization for standard words
                  that require it.
                </p>
                <p className={styles.block_203}>Correct: She is Australian.</p>
                ...
                <p className={styles.block_28}>Correct: Navigate home.</p>
                <p className={styles.block_55}>Incorrect: Navigate Home.</p>
              </div>
              <div id="context-error">
                ...
                <p className={styles.block_208}>Correct: 必须努力学习。</p>
                <p className={styles.block_209}>Incorrect: 必需努力学习。</p>
                <p className={styles.block_199}>Correct: 這是生活必需品。</p>
                <p className={styles.block_209}>Incorrect: 這是生活必须品</p>
                <p className={styles.block_210}>Correct: 决不同意。</p>
                <p className={styles.block_211}>Incorrect: 绝不同意。</p>
                <p className={styles.block_210}>Correct: 绝无此事。</p>
                <p className={styles.block_211}>Incorrect: 决无此事。</p>
                <p className={styles.block_212}>Correct: I ate apples.</p>
                <p className={styles.block_213}>Incorrect: I eight apples.</p>
                <p className={styles.block_214}>Correct: your favorite movie</p>
                ...
                <p className={styles.block_221}>Correct: 一支军队</p>
                <p className={styles.block_222}>Incorrect: 一枝军队</p>
                <p className={styles.block_221}>Correct: 一枝钢笔</p>
                <p className={styles.block_223}>Explanation: 一支钢笔</p>
                <p className={styles.block_224}>
                  Correct: 珊珠湖 or 山豬湖 or [skip]
                </p>
                <p className={styles.block_225}>
                  Explanation: homophones for geographic names
                </p>
                <p className={styles.block_74}>
                  Correct: The cupboard was bare.
                </p>
                <p className={styles.block_226}>
                  Incorrect: The cupboard was bear.
                </p>
                ...
                <p className={styles.block_228}>Correct: 也我有中国人朋友。</p>
                <p className={styles.block_229}>
                  Incorrect: 我也有中国人朋友。
                </p>
                <p className={styles.block_230}>
                  Example audio: " 也我有中国人朋友 "
                </p>
                <p className={styles.block_231}>
                  <span className={styles.text_2}>Correct: 他们是</span>
                  <span className={styles.text_3}>都</span>
                  <span className={styles.text_2}>我的同学。 </span>
                </p>
                <p className={styles.block_229}>
                  Incorrect: 他们都是我的同学。
                </p>
                <p className={styles.block_232}>
                  <span className={styles.text_2}>Example audio: " 他们是</span>
                  <span className={styles.text_3}>都</span>
                  <span className={styles.text_2}>我的同学 " </span>
                </p>
                <p className={styles.block_233}>Correct: She loves pizza.</p>
                <p className={styles.block_234}>Incorrect: She love pizza.</p>
                <p className={styles.block_118}>
                  Example audio: " she loves pizza "
                </p>
                <p className={styles.block_235}>Correct: She love pizza.</p>
                <p className={styles.block_55}>Incorrect: She loves pizza.</p>
                <p className={styles.block_236}>
                  Example audio: " she love pizza "
                </p>
              </div>
              <div id="adding-missing-words">
                ...
                <p className={styles.block_239}>Correct: 我要到山东。</p>
                <p className={styles.block_209}>Incorrect: 我要到山东省。</p>
                <p className={styles.block_240}>
                  Example audio: " 我要到山东 "
                </p>
                <p className={styles.block_210}>Correct: 这好好玩。</p>
                <p className={styles.block_241}>Incorrect: 这个好好玩。</p>
                <p className={styles.block_242}>Example audio: " 这好好玩 "</p>
              ...
              <div id="substitution">
                ...
                <p className={styles.block_208}>Correct: 我要去搭火车。</p>
                <p className={styles.block_209}>Incorrect: 我要去搭货车。</p>
                <p className={styles.block_255}>
                  Example audio: " 我要去搭火车 "
                </p>
                ...
                <p className={styles.block_258}>
                  Example audio: " take me to pizza hut "
                </p>
              </div>
              <div id="spacing">
                <p className={'heading'}>Spacing</p>
                <p className={'text'}>
                  Do not add spaces in most cases. If not sure, err on the side
                  of no space.
                </p>
                <p className={styles.block_260}>Correct: 我叫 MT。</p>
                <p className={styles.block_211}>Incorrect: 我叫 M T。</p>
                <p className={styles.block_261}>Example audio: " 我叫 m t "</p>
                <p className={styles.block_262}>Correct: 钱柜 KTV</p>
                <p className={styles.block_263}>Incorrect: 钱柜 K T V</p>
                <p className={styles.block_229}>
                  Example audio: " 钱柜 k t v "
                </p>
                <p className={styles.block_264}>Correct: FC2 视频</p>
                <p className={styles.block_265}>Incorrect: FC 2 视频</p>
                <p className={styles.block_266}>Incorrect: FC2 视频</p>
                <p className={styles.block_229}>
                  Example audio: " f c 二视频 "
                </p>
                <p className={styles.block_267}>Correct: 5kg</p>
                <p className={styles.block_67}>Incorrect: 5 kg</p>
                <p className={styles.block_268}>Incorrect: 5 k g</p>
                <p className={styles.block_199}>Example audio: " 五 k g "</p>
                <p className={styles.block_269}>
                  Do not add spaces even if there is an audible and obvious
                  pause.
                </p>
                <p className={styles.block_221}>Correct: 情非得已</p>
                <p className={styles.block_211}>Incorrect: 情 非 得 已</p>
                ...
                <p className={styles.block_221}>Correct: 你来不?</p>
                <p className={styles.block_272}>Incorrect: 你来不 ?</p>
                <p className={styles.block_273}>Correct: 闭嘴。</p>
                <p className={styles.block_264}>Incorrect: 闭嘴 。</p>
                <p className={styles.block_228}>Correct: 你好,我是黃先生。</p>
                ...
                <p className={styles.block_237}>Correct: images of dogs</p>
                <p className={styles.block_277}>Incorrect: image of _dogs</p>
                <p className={styles.block_217}>
                  Correct: I think so. Let's just try.
                </p>
                <p className={styles.block_75}>
                  Incorrect: I thinkso. Let's just try.
                </p>
              </div>
            </div>
          </Paper>
