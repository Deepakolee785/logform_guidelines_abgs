          ...
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <div id="number">
                ...
                <p className={'text'}>
                  Use Chinese characters for numbers less than or equal to 10.
                  Use Arabic numerals for numbers greater than 10. Unless
                  specified, use lowercase characters for 1 to 9, i.e.
                  一二三四五六七八九 instead of their full forms
                  ("壹貳參肆伍陸柒捌玖"). For zero, use "零" instead of "〇".
                </p>
                <p className={styles.block_345}>
                  Correct: 两个人,三到五天,三室一厅。
                </p>
                <p className={styles.block_379}>
                  Explanation: numbers less than ten
                </p>
                <p className={styles.block_380}>
                  Correct: 最後 14 堂星期二的課、50 音、班上有 13 個學生。
                </p>
                <p className={styles.block_381}>
                  Explanation: numbers greater than ten
                </p>
                <p className={styles.block_382}>
                  Use Arabic numerals fo numbers without units.
                </p>
                <p className={styles.block_375}>Correct: 99</p>
                <p className={styles.block_373}>Example audio: " 九九 "</p>
                <p className={styles.block_267}>Correct: 999</p>
                ...
                <p className={styles.block_384}>Correct: 5 万</p>
                <p className={styles.block_373}>Example audio: " 五万 "</p>
                <p className={styles.block_384}>Correct: 1 亿</p>
                <p className={styles.block_373}>Example audio: " 一亿 "</p>
                ...
                <p className={styles.block_210}>Correct: 降龙十八掌</p>
                <p className={styles.block_221}>Correct: 十二生肖</p>
                <p className={styles.block_390}>
                  Correct: 三室一厅、一房一厅一卫一厨
                </p>
                <p className={styles.block_391}>Correct: 六合彩</p>
                <p className={styles.block_392}>
                  Use Arabic numerals for monetary expressions.
                </p>
                <p className={styles.block_384}>Correct: 5 毛</p>
                <p className={styles.block_373}>Example audio: " 五毛 "</p>
                <p className={styles.block_393}>Correct: 2000 块</p>
                <p className={styles.block_394}>Example audio: " 兩千块 "</p>
                <p className={styles.block_265}>Correct: 奖金 900 元</p>
                <p className={styles.block_338}>
                  Example audio: " 奖金九百元 "
                </p>
                <p className={styles.block_260}>Correct: 收费 10 元</p>
                <p className={styles.block_242}>Example audio: " 收费十元 "</p>
                <p className={styles.block_395}>Correct: 每坪 32000</p>
                <p className={styles.block_396}>
                  Example audio: " 每坪三万二千 "
                </p>
                <p className={styles.block_222}>Correct: 月租 1800</p>
                <p className={styles.block_242}>Example audio: " 月租千八 "</p>
                <p className={styles.block_397}>
                  Transcribe other numbers the way you would write them down in
                  your language.
                </p>
                <p className={styles.block_199}>Correct: 座位在 7 排 8 号。</p>
                <p className={styles.block_398}>
                  Example audio: " 座位在七排八号 "
                </p>
                <p className={styles.block_394}>Correct: 坐 355 到五道口。</p>
                <p className={styles.block_399}>
                  Example audio: " 坐三五五到五道口。 "
                </p>
                <p className={styles.block_400}>
                  Correct: 现在双方的比数是 2 比 1。
                </p>
                <p className={styles.block_401}>
                  Example audio: " 现在双方的比数是二比一 "
                </p>
                <p className={styles.block_402}>Explanation: as in scores</p>
                <p className={styles.block_323}>
                  Correct: 橙子与柠檬之比例为 4:3。
                </p>
                <p className={styles.block_403}>
                  Example audio: " 橙子与柠檬之比例为四比三 "
                </p>
                <p className={styles.block_404}>
                  Explanation: as in proportion
                </p>
                <p className={styles.block_405}>
                  Correct: 目前血红素指数是 3.14。
                </p>
                <p className={styles.block_403}>
                  Example audio: " 目前血红素指数是三點一四 "
                </p>
                <p className={styles.block_272}>Correct: 101 斑點狗</p>
                <p className={styles.block_255}>
                  Example audio: " 一零一斑點狗 "
                </p>
                <p className={styles.block_210}>Correct: 一零一中学</p>
                <p className={styles.block_246}>
                  Example audio: " 一零一中学 or 幺零幺中学 "
                </p>
                <p className={styles.block_406}>Correct: 7-Eleven</p>
                <p className={styles.block_407}>
                  Example audio: " seven eleven "
                </p>
                <p className={styles.block_408}>
                  Explanation: convenience store
                </p>
                <p className={styles.block_91}>Correct: Nexus 7</p>
                <p className={styles.block_147}>
                  Example audio: " nexus seven "
                </p>
                <p className={styles.block_409}>Example audio: " nexus 七 "</p>
                <p className={styles.block_209}>Correct: 三星 GALAXY S2</p>
                <p className={styles.block_410}>
                  Example audio: " 三星 galaxy s two "
                </p>
                ...
                <p className={styles.block_416}>
                  Correct: 他们要买 1/4 公升的牛奶。
                </p>
                <p className={styles.block_417}>
                  Incorrect: 他们要买四分之一公升的牛奶。
                </p>
                <p className={styles.block_418}>
                  Incorrect: 他们要买 1 / 4 公升的牛奶。
                </p>
                <p className={styles.block_419}>
                  Incorrect: 他们要买 1⁄4 公升的牛奶。(bad because it includes
                  the pre-combined fraction 1⁄4)
                </p>
                <p className={styles.block_314}>
                  Incorrect: 他们要买 0.25 公升的牛奶。
                </p>
                ...
                <p className={styles.block_422}>Correct: 2/3 x 5/16</p>
                <p className={styles.block_423}>Incorrect: 2/3 * 5/16</p>
                <p className={styles.block_239}>Incorrect: 2/3 乘 5/16</p>
                <p className={styles.block_316}>
                  Incorrect: 三分之二乘十六分之五
                </p>
                <p className={styles.block_424}>
                  Example audio: " 三分之二乘十六分之五 "
                </p>
                <p className={styles.block_425}>
                  For mixed numbers in math and units &amp; measures, use Arabic
                  numerals with "又".
                </p>
                <p className={styles.block_426}>Correct: 3 又 1/2 公里</p>
                <p className={styles.block_230}>
                  Example audio: " 三又二分之一公里 "
                </p>
                <p className={styles.block_427}>
                  Correct: 那只可拉熊重 12 又 1/3 磅。
                </p>
                <p className={styles.block_428}>
                  Example audio: " 那只可拉熊重十二又三分之一磅。 "
                </p>
                <p className={styles.block_426}>Correct: 5 又 1/2 个月</p>
                <p className={styles.block_429}>Incorrect: 5.5 个月</p>
                <p className={styles.block_430}>
                  Example audio: " 五又二分之一個月 "
                </p>
                <p className={styles.block_431}>Correct: 1/3 + 3 又 1/2</p>
                <p className={styles.block_352}>Incorrect: 1/3 + 3 1/2</p>
                <p className={styles.block_432}>
                  Example audio: " 三分之一加三又二分之一 "
                </p>
                ...
                <p className={styles.block_295}>
                  Correct: 你可以借我 2.5 美元嗎?
                </p>
                <p className={styles.block_401}>
                  Example audio: " 你可以借我二点五美元嗎 "
                </p>
                <p className={styles.block_434}>
                  Correct: 这东西要价 10.7 欧。
                </p>
                <p className={styles.block_362}>
                  Example audio: " 这东西要价十点七欧 "
                </p>
                ...
                <p className={styles.block_200}>Correct: 脂肪含量 2%的牛奶</p>
                <p className={styles.block_401}>
                  Example audio: " 脂肪含量百分之二的牛奶 "
                </p>
                <p className={styles.block_405}>
                  Correct: 这次卖出了 30%的存货。
                </p>
                <p className={styles.block_436}>
                  Example audio: " 这次卖出了百分之三十的存货 "
                </p>
                <p className={styles.block_239}>Correct: 百分之一百万</p>
                <p className={styles.block_255}>
                  Example audio: " 百分之一百万 "
                </p>
                ...
                <p className={styles.block_438}>Correct: 1 + 1 = 2</p>
                <p className={styles.block_396}>
                  Example audio: " 一加一等于二 "
                </p>
                <p className={styles.block_439}>Correct: 5 x 6</p>
                <p className={styles.block_393}>Incorrect: 五乘六</p>
                <p className={styles.block_440}>Incorrect: 5 乘 6</p>
                <p className={styles.block_441}>Incorrect: 5x6</p>
                <p className={styles.block_394}>Example audio: " 五乘六 "</p>
                <p className={styles.block_242}>Example audio: " 五乘以六 "</p>
                ...
                <p className={styles.block_239}>Correct: 暗黑破坏神 III</p>
                <p className={styles.block_255}>
                  Example audio: " 暗黑破坏神三 "
                </p>
                <p className={styles.block_443}>Correct: 星际争霸 II</p>
                <p className={styles.block_338}>
                  Example audio: " 星际争霸二 "
                </p>
                <p className={styles.block_444}>Correct: SK-II</p>
                <p className={styles.block_55}>Example audio: " s k two "</p>
                ...
                <p className={styles.block_426}>Correct: 中国好声音 3</p>
                <p className={styles.block_241}>Incorrect: 中国好声音三</p>
                <p className={styles.block_431}>Correct: 兰陵王第 24 集</p>
                <p className={styles.block_200}>Incorrect: 兰陵王第二十四集</p>
                <p className={styles.block_447}>Correct: 变形金刚 2</p>
                <p className={styles.block_211}>Incorrect: 变形金刚二</p>
                ...
                <p className={styles.block_7}>Correct: +86-10-1112-3478</p>
                <p className={styles.block_454}>
                  Explanation: landline with country code
                </p>
                <p className={styles.block_13}>Correct: 0086-312-260-7433</p>
                ...
                <p className={styles.block_237}>Correct: 010-6277-6544</p>
                <p className={styles.block_456}>Explanation: landline</p>
                <p className={styles.block_237}>Correct: 0991-123-1234</p>
                <p className={styles.block_456}>Explanation: landline</p>
                <p className={styles.block_457}>Correct: 137-1609-5627</p>
                <p className={styles.block_458}>
                  Explanation: mobile phone number
                </p>
                <p className={styles.block_459}>Correct: 400-123-1234</p>
                <p className={styles.block_334}>
                  Explanation: toll-free number
                </p>
                <p className={styles.block_459}>Correct: 800-123-1234</p>
                <p className={styles.block_334}>
                  Explanation: toll-free number
                </p>
                ...
                <p className={styles.block_462}>
                  Correct: 公交 756 or 756 公交
                </p>
                <p className={styles.block_463}>Correct: XT660</p>
                <p className={styles.block_464}>
                  Explanation: Yamaha motorcycle
                </p>
              </div>
              <div id="currency-and-unit">
                ...
                <p className={styles.block_466}>
                  Use Chinese characters for currencies.
                </p>
                <p className={styles.block_467}>Correct: 20 元</p>
                <p className={styles.block_394}>Example audio: " 二十元 "</p>
                <p className={styles.block_467}>Correct: 20 块</p>
                <p className={styles.block_394}>Example audio: " 二十块 "</p>
                <p className={styles.block_468}>Correct: 20 块钱</p>
                <p className={styles.block_242}>Example audio: " 二十块钱 "</p>
                <p className={styles.block_469}>Correct: 20 美元</p>
                <p className={styles.block_140}>Incorrect: $20</p>
                <p className={styles.block_242}>Example audio: " 二十美元 "</p>
                <p className={styles.block_467}>Correct: 25 欧</p>
                <p className={styles.block_242}>Example audio: " 二十五欧 "</p>
                <p className={styles.block_468}>Correct: 50 英镑</p>
                <p className={styles.block_242}>Example audio: " 五十英镑 "</p>
                <p className={styles.block_470}>
                  For ranges or non-specific currency quantities, write
                  everything out as spoken.
                </p>
                <p className={styles.block_390}>
                  Correct: 那台冷气可能要三或四万块。
                </p>
                <p className={styles.block_323}>
                  Incorrect: 那台冷气可能要三四万块
                </p>
                <p className={styles.block_471}>Correct: 可以借我两三百元吗?</p>
                <p className={styles.block_323}>
                  Incorrect: 可以借我兩、三百元吗?
                </p>
                ...
                <p className={styles.block_379}>
                  Correct: one to five hundred dollars
                </p>
                <p className={styles.block_473}>Correct: 100 to 500 dollars</p>
                ...
                <p className={styles.block_15}>Correct: 256MB</p>
                <p className={styles.block_476}>
                  Example audio: " 二五六 megabytes "
                </p>
                ...
                <p className={styles.block_478}>Correct: 50mm</p>
                <p className={styles.block_229}>Example audio: " 五十 m m "</p>
                <p className={styles.block_267}>Correct: 5kg</p>
                <p className={styles.block_199}>Example audio: " 五 k g "</p>
                <p className={styles.block_110}>Correct: 750W</p>
                <p className={styles.block_479}>
                  Example audio: " seven hundred fifty watt "
                </p>
                <p className={styles.block_480}>
                  Transcribe Chinese units as spoken.
                </p>
                <p className={styles.block_468}>Correct: 80 平方</p>
                <p className={styles.block_242}>Example audio: " 八十平方 "</p>
                <p className={styles.block_481}>Correct: 100 米</p>
                <p className={styles.block_394}>Example audio: " 一百米 "</p>
                <p className={styles.block_482}>Correct: 3 公里</p>
                <p className={styles.block_483}>Example audio: " 三公里 "</p>
                <p className={styles.block_481}>Correct: 750 瓦</p>
                <p className={styles.block_338}>
                  Example audio: " 七百五十瓦 "
                </p>
                <p className={styles.block_484}>Correct: 5 千克</p>
                <p className={styles.block_394}>Example audio: " 五千克 "</p>
                <p className={styles.block_462}>
                  Explanation: "千克" as a unit
                </p>
                <p className={styles.block_485}>
                  Transcribe all numeric values preceding units in numeral form,
                  even if under 10.
                </p>
                <p className={styles.block_199}>Correct: 这只小猫 3 磅重。</p>
                <p className={styles.block_230}>
                  Example audio: " 这只小猫三磅重。 "
                </p>
                <p className={styles.block_486}>
                  Correct: 我今天喝了 2 公升的水。
                </p>
                <p className={styles.block_401}>
                  Example audio: " 我今天喝了兩公升的水。 "
                </p>
              </div>
              <div id="date-and-time">
                <p className={'heading'}>Date and time</p>
                <p className={styles.block_487}>
                  Use Arabic numerals for dates.
                </p>
                <p className={styles.block_488}>Correct: 2011 年 4 月 28 日</p>
                <p className={styles.block_401}>
                  Example audio: " 二零一一年四月二十八日 "
                </p>
                <p className={styles.block_209}>Correct: 2009 年 2 至 4 月</p>
                <p className={styles.block_362}>
                  Example audio: " 二零零九年二至四月 "
                </p>
                <p className={styles.block_255}>
                  Correct: 保存期限是到 05102012
                </p>
                <p className={styles.block_455}>
                  Example audio: " 保存期限是到零五一零二零一二 "
                </p>
                <p className={styles.block_489}>Correct: 鄧麗君 90 演唱會</p>
                <p className={styles.block_230}>
                  Example audio: " 鄧麗君九零演唱會 "
                </p>
                <p className={styles.block_221}>Correct: 12 月 12</p>
                <p className={styles.block_338}>
                  Example audio: " 十二月十二 "
                </p>
                <p className={styles.block_490}>Correct: 3.15 消费者权益日</p>
                <p className={styles.block_399}>
                  Example audio: " 三幺五消费者权益日 "
                </p>
                <p className={styles.block_491}>
                  When the date is spoken as a sequence of numbers, transcribe
                  as such.
                </p>
                <p className={styles.block_423}>Correct: 19/12/2014</p>
                <p className={styles.block_403}>
                  Example audio: " 十九斜杠十二斜杠二零一四 "
                </p>
                <p className={styles.block_492}>
                  Explanation: Don't add slash or dash unless explicitly spoken
                  or if it is very unnatural to leave them out (if in doubt,
                  leave them out).
                </p>
                <p className={styles.block_493}>Correct: 2010-7-13</p>
                <p className={styles.block_362}>
                  Example audio: " 二零一零槓七槓十三 "
                </p>
                <p className={styles.block_492}>
                  Explanation: Don't add slash or dash unless explicitly spoken
                  or if it is very unnatural to leave them out (if in doubt,
                ...
                <p className={styles.block_384}>Correct: 2 点</p>
                <p className={styles.block_373}>Example audio: " 兩点 "</p>
                <p className={styles.block_496}>Correct: 2 时 05 分</p>
                <p className={styles.block_338}>
                  Example audio: " 两时零五分 "
                </p>
                <p className={styles.block_272}>Correct: 11 点 58 分</p>
                <p className={styles.block_398}>
                  Example audio: " 十一点五十八分 "
                </p>
                <p className={styles.block_427}>
                  Correct: 主任领班说下午 5 点 40 分。
                </p>
                <p className={styles.block_403}>
                  Example audio: " 主任领班说下午五点四十分 "
                </p>
                <p className={styles.block_370}>Correct: 3 点 15</p>
                <p className={styles.block_242}>Example audio: " 三点十五 "</p>
                <p className={styles.block_497}>Correct: 3 点一刻</p>
                <p className={styles.block_498}>Example audio: " 三点一刻 "</p>
                <p className={styles.block_499}>Correct: 6 点半到 12 点三刻</p>
                <p className={styles.block_362}>
                  Example audio: " 六点半到十二点三刻 "
                </p>
                <p className={styles.block_500}>Correct: 4 p.m.</p>
                <p className={styles.block_490}>Example audio: " 四 p m "</p>
                <p className={styles.block_501}>
                  Explanation: Use p.m. and a.m. if spoken.
                </p>
                ...
                <p className={styles.block_255}>
                  Incorrect: 7 个月,4 周,1 天 2 夜
                </p>
                <p className={styles.block_502}>Correct: 24 个月,39 周,14 天</p>
                <p className={styles.block_417}>
                  Incorrect: 二十四个月,三十九周,十四天
                </p>
                <p className={styles.block_503}>
                  Use Chinese characters in "星期".
                </p>
                <p className={styles.block_273}>Correct: 星期一</p>
                <p className={styles.block_504}>Incorrect: 星期 1</p>
              </div>
              <div id="address">
                ...
                <p className={styles.block_263}>Correct: 14 号楼 605</p>
                <p className={styles.block_398}>
                  Example audio: " 十四号楼六零五 "
                </p>
                <p className={styles.block_506}>
                  Correct: 北京市朝阳区国家体育场南路 1 号
                </p>
                <p className={styles.block_507}>
                  Correct: 上海市徐汇区中山南二路 12 号 17 幢西 1 之 3 楼
                </p>
                <p className={styles.block_508}>
                  Explanation: Use Chinese characters for street names and
                  section number, but Arabic numerals for lane numbers, house
                  numbers and floor numbers. Use "之" instead of hyphens.
                </p>
              ...
              <div id="web">
                ...
                <p className={styles.block_512}>
                  ...
                  <span className={styles.text_1}>www.google.com </span>
                </p>
                <p className={styles.block_513}>
                  Example audio: " san1 w dian3 google dian3 com "
                </p>
                <p className={styles.block_7}>Correct: wang@google.com</p>
                <p className={styles.block_428}>
                ...
                <p className={styles.block_7}>Correct: newyorktimes.com</p>
                ...
                <p className={styles.block_518}>
                  <span className={styles.text_}>Correct: </span>
                  <span className={styles.text_1}>www.123.com </span>
                </p>
                ...
                <p className={styles.block_140}>Correct: www.</p>
                <p className={styles.block_521}>
                  Example audio: " san1 w dian3 "
                </p>
                ...
                <p className={styles.block_524}>Correct: .com</p>
                <p className={styles.block_525}>Example audio: " dian3 com "</p>
                <p className={styles.block_41}>Correct: 163.com</p>
              ...
              <div id="abbreviation">
                ...
                <p className={styles.block_531}>
                  Example audio: " warriors versus lakers "
                </p>
                <p className={styles.block_167}>
                  Correct: Warriors verse Lakers
                </p>
                <p className={styles.block_530}>
                  Incorrect: Warriors vs. Lakers
                </p>
                <p className={styles.block_532}>
                  Example audio: " warriors verse lakers "
                </p>
                <p className={styles.block_7}>Correct: Warriors vs. Lakers</p>
                <p className={styles.block_44}>
                  Example audio: " warriors v s lakers "
                </p>
                <p className={styles.block_533}>Correct: Roe v. Wade</p>
                <p className={styles.block_534}>
                  Example audio: " roe v wade "
                </p>
                ...
                <p className={styles.block_536}>Correct: 这是 Mr.杜。</p>
                <p className={styles.block_319}>
                  Example audio: " 这是 mister 杜 "
                </p>
                <p className={styles.block_537}>
                  Correct: 请问 Dr. Smith 在吗?
                </p>
                <p className={styles.block_318}>
                  Example audio: " 请问 doctor smith 在吗 "
                </p>
                ...
                <p className={styles.block_541}>Correct: Dr.eye 移动电视</p>
                <p className={styles.block_394}>Incorrect: Dr eye 移动电视</p>
                <p className={styles.block_400}>
                  Explanation: doctor eye 移动电视
                </p>
                <p className={styles.block_542}>
                  For English: In acronyms, do not use periods between letters.
                </p>
                <p className={styles.block_543}>Correct: AT&amp;T, MP3</p>
                ...
                <p className={styles.block_545}>Correct: NASA</p>
