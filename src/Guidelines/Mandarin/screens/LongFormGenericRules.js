          ...
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <div id="speaker-labeling">
                ...
                <p className={styles.block_145}>Correct: speaker 1</p>
                <p className={styles.block_146}>Incorrect: Speaker 1</p>
              ...
              <div id="pii">
                ...
                <p className={styles.block_158}>NAME: First and/or Last name</p>
                <p className={styles.block_159}>CREDIT_CARD_NUMBER</p>
                <p className={styles.block_160}>EMAIL</p>
                <p className={styles.block_91}>PHONE_NUMBER</p>
                <p className={styles.block_161}>SOCIAL_INSURANCE_NUMBER</p>
                <p className={styles.block_162}>DRIVER_LICENSE_NUMBER</p>
                <p className={styles.block_163}>
                  NATIONAL_HEALTH_SERVICE_NUMBER
                </p>
                <p className={styles.block_97}>SOCIAL_SECURITY_NUMBER</p>
                <p className={styles.block_164}>PASSPORT</p>
                ...
                <p className={styles.block_167}>MRN (medical record number)</p>
                ...
                <p className={styles.block_174}>
                  MICR. MICR means Magnetic Image Character Recognition. The
                  MICR is made up of three sets of numbers. The first set is
                ...
                <p className={styles.block_146}>MEDICARE_NUMBER</p>
                ...
                <p className={styles.block_180}>FDA_CODE: Prescription drug</p>
                ...
                <p className={styles.block_182}>TAXPAYER_REFERENCE</p>
                ...
                <p className={styles.block_189}>Correct: Pet names</p>
              </div>
            </div>
          </Paper>
        </Grid>
