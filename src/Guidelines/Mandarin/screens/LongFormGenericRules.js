        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p class="block_135">Longform generic rules</p>
              <p class="block_47">
              ...
              <p class="block_136">Unintelligible or foreign or singing</p>
              <p class="block_137">
              ...
              <p class="block_140">Segmentation</p>
              <p class="block_141">
              ...
              <p class="block_91">Speaker labeling</p>
              <p class="block_144">
              ...
              <p class="block_145">Correct: speaker 1</p>
              <p class="block_146">Incorrect: Speaker 1</p>
              <p class="block_147">Correct: pre recorded speaker 1</p>
              <p class="block_148">Incorrect: pre-recorded speaker_1</p>
              <p class="block_149">Correct: unidentifiable speaker</p>
              <p class="block_150">
                'speaker #' Used for different speakers in the audio. Includes a
                number that corresponds to each different speaker.
              </p>
              <p class="block_151">
                'pre recorded speaker #' Used when there is speech coming from a
                machine. Includes a number that corresponds to each different
              ...
              <p class="block_153">
                'speaker Tom' Used when the name of a speaker becomes known. The
                names of speakers should always be capitalized. You can use
              ...
              <p class="block_158">NAME: First and/or Last name</p>
              <p class="block_159">CREDIT_CARD_NUMBER</p>
              <p class="block_160">EMAIL</p>
              <p class="block_91">PHONE_NUMBER</p>
              <p class="block_161">SOCIAL_INSURANCE_NUMBER</p>
              <p class="block_162">DRIVER_LICENSE_NUMBER</p>
              <p class="block_163">NATIONAL_HEALTH_SERVICE_NUMBER</p>
              <p class="block_97">SOCIAL_SECURITY_NUMBER</p>
              <p class="block_164">PASSPORT</p>
              <p class="block_165">
                TAX_FILE_NUMBER: A tax file number (TFN) is a unique identifier
                issued by the Australian Taxation Office (ATO) to each taxpaying
                entity
              </p>
              <p class="block_166">
                LOCATION_STREET: If the street name is heard, mark as PII. Other
                locations such as State, City, County, zip code are all OK to
                transcribe.
              </p>
              <p class="block_129">
              ...
              <p class="block_167">MRN (medical record number)</p>
              <p class="block_168">
              ...
              <p class="block_169">OHIP: Ontario Health Insurance Plan</p>
              <p class="block_170">
              ...
              <p class="block_173">
                BANK_ROUTING_MICR: The numbers located on the bottom of a check
                is called a
              </p>
              <p class="block_174">
                MICR. MICR means Magnetic Image Character Recognition. The MICR
                is made up of three sets of numbers. The first set is called the
              ...
              <p class="block_146">MEDICARE_NUMBER</p>
              <p class="block_176">
              ...
              <p class="block_180">FDA_CODE: Prescription drug</p>
              <p class="block_181">
                <span class="text_">
                  NIF: Tax Identification Number in Spain{' '}
                </span>
                <span class="text_1">
                  http :// www . investinspain . org / guidetobusiness / en / 2
                  / art _ 2 _ 3 . html
                </span>
              </p>
              <p class="block_182">TAXPAYER_REFERENCE</p>
              <p class="block_183">
              ...
              <p class="block_186">examples of things that are not PII are:</p>
              <p class="block_187">
              ...
              <p class="block_189">Correct: Pet names</p>
            </div>
          </Paper>
        </Grid>
        <Hidden smDown>
