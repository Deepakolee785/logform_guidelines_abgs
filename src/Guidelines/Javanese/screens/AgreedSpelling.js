        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.calibre1}>Agreed spelling </p>
              ...
              <p className={styles.block_343}>
                <span className={styles.calibre1}>Spelling out </span>
              </p>
              ...
              <p className={styles.block_196}>
                <span className={styles.calibre1}>Interjections </span>
              </p>
              ...
              <p className={styles.block_349}>
                ...
                <span className={styles.text_35}>
                  <span className={styles.calibre2}>Proper names </span>
                </span>
              </p>
              ...
              <p className={styles.block_353}>
                ...
                <span className={styles.text_1}> </span>
                <span className={styles.text_}>
                  spelling, use the spelling that yields the most Google search
                  hits when you search for&nbsp;
                </span>
                <span className={styles.text_1}> </span>
                <span className={styles.text_}>
                  the name followed by the word "name" (without quotation marks)
                  (e.g. "Anna name").&nbsp;
                </span>
                <span className={styles.text_1}> </span>
              </p>
              ...
              <p className={styles.block_354}>
                <span className={styles.calibre1}>Brand and product </span>
              </p>
              ...
              <p className={styles.block_357}>
                <span className={styles.calibre1}>Media title </span>
              </p>
              <p className={styles.block_358}>
                <span className={styles.text_}>
                  Refer to the Google Play Store for official spellings of media
                  titles. For film/television,&nbsp;
                </span>
                <span className={styles.text_1}> </span>
                <span className={styles.text_}>
                  IMDb is also available. If an utterance is ambiguous between a
                  media title and a&nbsp;
                </span>
                <span className={styles.text_1}> </span>
                <span className={styles.text_}>
              ...
              <p className={styles.block_357}>
                <span className={styles.calibre1}>Multiple spellings </span>
              </p>
              <p className={styles.block_361}>
                ...
                <span className={styles.text_1}> </span>
                <span className={styles.text_}>
                  dictionary for your language. If there is no entry, Google the
                  word and use the form with&nbsp;
                </span>
                <span className={styles.text_1}> </span>
