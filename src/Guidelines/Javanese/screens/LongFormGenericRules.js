          ...
          <Paper className={classes.content}>
            ...
            <div className="content">
              <p className={styles.block_75}>
                <span className={styles.calibre1}>Longform generic rules </span>
              </p>
              <p className={styles.block_76}>
                ...
                <span className={styles.text_1}> </span>
                <span className={styles.text_}>heard.&nbsp;</span>
                <span className={styles.text_1}> </span>
              </p>
              ...
              <p className={styles.block_81}>
                <span className={styles.calibre1}>Segmentation </span>
              </p>
              ...
              <p className={styles.block_83}>
                ...
                <span className={styles.text_1}> </span>
                <span className={styles.text_}>
                  a speaker does pause their speech for longer than 0.5 seconds,
                  end the speaker turn&nbsp;
                </span>
                <span className={styles.text_1}> </span>
                <span className={styles.text_}>
              ...
              <p className={styles.block_84}>
                ...
                <span className={styles.text_1}> </span>
                <span className={styles.text_}>
                  than 30 consecutive seconds without taking a 0.5 second pause,
                  then end the turn at&nbsp;
                </span>
                <span className={styles.text_1}> </span>
                <span className={styles.text_}>
              ...
              <p className={styles.block_81}>
                <span className={styles.calibre1}>Speaker labeling </span>
              </p>
              ...
              <p className={styles.block_90}>
                ...
                <span className={styles.text_6}>
                  ...
                  a number that&nbsp; corresponds to each different
                  speaker.&nbsp;
                </span>
              </p>
              ...
              <p className={styles.block_92}>
                ...
                <span className={styles.text_6}>
                  ...
                  The names of&nbsp; speakers should always be capitalized. You
                  can use first and last names. (Note:&nbsp; adding speaker
              ...
              <p className={styles.block_93}>
                <span className={styles.calibre1}>Audio labels </span>
              </p>
              ...
              <p className={styles.block_102}>
                <span className={styles.calibre1}>Pii </span>
              </p>
              ...
              <p className={styles.block_104}>
                ...
                <span className={styles.text_1}> </span>
                <span className={styles.text_}>
                  captures the audio range of the PII speech. Add the PII label
                  and assign to the&nbsp;
                </span>
                <span className={styles.text_1}> </span>
                <span className={styles.text_}>
              ...
              <p className={styles.block_105}>
                ...
                <span className={styles.text_1}> </span>
                <span className={styles.text_}>
                  parent 'PII' label. If the appropriate PII subcategory is not
                  available then select the&nbsp;
                </span>
                <span className={styles.text_1}> </span>
                <span className={styles.text_}>
              ...
              <p className={styles.block_107}>
                <span className={styles.text_7}>● </span>
                <span className={styles.text_9}>CREDIT_CARD_NUMBER&nbsp; </span>
              </p>
              <p className={styles.block_107}>
                <span className={styles.text_7}>● </span>
              ...
              <p className={styles.block_112}>
                ...
                <span className={styles.text_6}>
                  ...
                  Plan (MSP) is&nbsp; given a unique lifetime identifier for
              ...
              <p className={styles.block_114}>
                ...
                <span className={styles.text_6}>
                  ...
                  document consisting of a laminated plastic card&nbsp; bearing
                  a photograph, name and address.&nbsp;
                </span>
              </p>
              <p className={styles.block_115}>
                ...
                <span className={styles.text_6}>
                  ...
                  internationally&nbsp; agreed system of identifying bank
                  accounts&nbsp;
                </span>
              </p>
              ...
              <p className={styles.block_119}>
                ...
                <span className={styles.text_6}>
                  ...
                  revenue agency to both Brazilians&nbsp; and resident aliens
                  who are subject to taxes in Brazil&nbsp;
                </span>
              </p>
              ...
              <p className={styles.block_121}>
                ...
                <span className={styles.text_6}>
                  ...
                  unique&nbsp; personal number allocated to everyone registered
              ...
              <p className={styles.block_122}>
                ...
                <span className={styles.text_6}>
                  ...
                  and Related Health&nbsp; Problems (ICD), a medical
              ...
              <p className={styles.block_107}>
                <span className={styles.text_7}>● </span>
                <span className={styles.text_9}>TAXPAYER_REFERENCE&nbsp; </span>
              </p>
