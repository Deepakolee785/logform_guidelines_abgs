          ...
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <p className={styles.block_156}>
                ...
                <span className={styles.text_1}> </span>
                <span className={styles.text_}>
                  nevertheless be treated as a sentence because of its context,
                  e.g. if it's an answer to a&nbsp;
                </span>
              </p>
              ...
              <p className={styles.block_158}>
                Correct: Awakmu ngomongna sapa?&nbsp; Sedulurmu ing Pati.&nbsp;
              </p>
              <p className={styles.block_159}>
                Explanation: Dua penutur. "Sedulurmu." adalah&nbsp; jawaban atas
                pertanyaan spesifik.&nbsp;
              </p>
              ...
              <p className={styles.block_170}>
                ...
                <span className={styles.text_1}> </span>
                <span className={styles.text_}>
                  punctuation to sentence fragments that sound like the end of a
              ...
              <p className={styles.block_178}>
                Explanation: Jangan beri titik, tanda hubung,&nbsp; atau elipsis
                setelah fragmen, meski diikuti&nbsp; kalimat lain.&nbsp;
              </p>
              ...
              <p className={styles.block_184}>
                <span className={styles.calibre1}>Commas </span>
              </p>
              ...
              <p className={styles.block_188}>
                Explanation: Meski penutur menggunakan jeda&nbsp; yang panjang,
                jangan gunakan koma untuk&nbsp; menunjukkan jeda tersebut.
                Penggunaan koma&nbsp; diperbolehkan atau diperlukan di&nbsp;
              </p>
              ...
              <p className={styles.block_192}>
                Correct: Biyoh-biyoh, awakmu pantes gawe&nbsp; klambi iki.&nbsp;
              </p>
              <p className={styles.block_193}>Explanation: Interjeksi.&nbsp;</p>
              ...
              <p className={styles.block_196}>
                <span className={styles.calibre1}>Intonation marks </span>
              </p>
              ...
              <p className={styles.block_200}>
                ...
                <span className={styles.text_19}>
                  Explanation: Intonasi naik menyiratkan bahwa&nbsp; ini adalah
                  pertanyaan, jadi beri tanda baca&nbsp;
                </span>
              </p>
              ...
              <p className={styles.block_206}>
                <span className={styles.text_18}>Correct: Hore.&nbsp; </span>
                <span className={styles.text_19}>
                  Explanation: Penutur terdengar tidak&nbsp; bersemangat.&nbsp;
                </span>
              </p>
              <p className={styles.block_207}>Colon and quotation</p>
              ...
              <p className={styles.block_209}>
                ...
                <span className={styles.text_19}>
                  Incorrect: Kancaku ngomong, "bukuku."&nbsp; Incorrect: Kancaku
                  ngomong "bukuku."&nbsp; Incorrect: Kancaku ngomong
                  "bukuku".&nbsp;
                </span>
              </p>
              ...
              <p className={styles.block_212}>
                Explanation: Jangan beri koma jika kata&nbsp; kerjanya berbentuk
                imperatif.&nbsp;
              </p>
              <p className={styles.block_213}>
                ...
                <span className={styles.text_1}> </span>
                <span className={styles.text_}>
                  utterance. Do not alter its end punctuation even if the quote
                  is within a sentence. Do not&nbsp;
                </span>
                <span className={styles.text_1}> </span>
                <span className={styles.text_}>
              ...
              <p className={styles.block_231}>
                <span className={styles.calibre1}>Other symbols </span>
              </p>
              ...
              <p className={styles.block_240}>
                Correct: Hai {`{koma} `}piye kabare {`{tandha&nbsp; pitakonan}`}{' '}
                Aku apik-apik wae {`{titik}`}&nbsp;
              </p>
              ...
              <p className={styles.block_244}>
                ...
                <span className={styles.text_20}>oke titik titik titik ​</span>
                <span className={styles.text_17}>"&nbsp; </span>
              </p>
              <p className={styles.block_245}>
                <span className={styles.text_17}>Example audio: "​ </span>
                <span className={styles.text_20}>
                  hai koma piye kabare tandha&nbsp; pitakonan aku apik-apik wae
                  titik ​
                </span>
                <span className={styles.text_17}>"&nbsp; </span>
              </p>
              ...
              <p className={styles.block_249}>
                Incorrect: Aku manggon ing apartemen 4&nbsp; {`{tandha hubung}`}{' '}
                A.&nbsp;
              </p>
              ...
              <p className={styles.block_253}>
                Incorrect: www {`{titik}`} fake {`{tandha hubung}`}&nbsp; domain{' '}
                {`{titik}`}
                com&nbsp;
              </p>
              ...
              <p className={styles.block_86}>Correct: {`{titik dua}`}&nbsp;</p>
              <p className={styles.block_88}>Correct: {`{underscore}`}&nbsp;</p>
              <p className={styles.block_260}>
                ...
                <span className={styles.text_1}> </span>
                <span className={styles.text_}>sentence as normal.&nbsp;</span>
                <span className={styles.text_1}> </span>
              </p>
              <p className={styles.block_261}>
                Correct: Aku budhal saiki {`{period}`} Pirang jam&nbsp; lelungan
