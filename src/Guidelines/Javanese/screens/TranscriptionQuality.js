          ...
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.block_129}>
                <span className={styles.calibre1}>Transcription quality </span>
              </p>
              ...
              <p className={styles.block_131}>
                <span className={styles.calibre1}>Typo </span>
              </p>
              ...
              <p className={styles.block_133}>
                <span className={styles.calibre1}>Context error </span>
              </p>
              <p className={styles.block_134}>
                <span className={styles.text_}>
                  Kesalahan konteks terjadi jika kata yang sebenarnya digunakan
                  secara salah atau jika&nbsp;
                </span>
                <span className={styles.text_1}> </span>
                <span className={styles.text_}>
              ...
              <p className={styles.block_89}>Incorrect: Putrane lara.&nbsp;</p>
              ...
              <p className={styles.block_14}>
                <span className={styles.calibre1}>Added or missing words </span>
              </p>
              <p className={styles.block_137}>
                ...
                <span className={styles.text_1}> </span>
                <span className={styles.text_}>
                  speaker. Avoid putting words in the speaker's mouth. However,
                  do transcribe implied&nbsp;
                </span>
                <span className={styles.text_1}> </span>
                <span className={styles.text_}>
              ...
              <p className={styles.block_141}>
                Explanation: Implied currency, add "Rp" even&nbsp; though it is
                not spoken.&nbsp;
              </p>
              ...
              <p className={styles.block_146}>
                <span className={styles.calibre1}>Substitution </span>
              </p>
              <p className={styles.block_147}>
                <span className={styles.calibre1}>Spacing </span>
              </p>
              ...
              <p className={styles.block_152}>
                <span className={styles.text_}>
                  ...
                  preceding word and the&nbsp;
                </span>
                <span className={styles.text_1}></span>
                <span className={styles.text_}>punctuation.&nbsp;</span>
                <span className={styles.text_1}> </span>
              </p>
              <p className={styles.block_86}>Correct: Awakmu teko kan?&nbsp;</p>
              <p className={styles.block_89}>
