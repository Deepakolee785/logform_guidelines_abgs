          ...
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <p class="block_175">
                ...
                nested underneath the parent 'PII' label. If the appropriate PII
                subcategory is not available then select the parent 'PII' label
                to cover all other cases. If there are no PII subcategories
                available to choose from then use the 'PII' label for all cases
                of PII.{' '}
              </p>
              <p class="block_176">
                See the below list for all valid PII items{' '}
              </p>
              <p class="block_177">● NAME: First and/or Last name </p>
              <p class="block_178">● CREDIT_CARD_NUMBER </p>
              <p class="block_179">● EMAIL </p>
              <p class="block_180">● PHONE_NUMBER </p>
              <p class="block_181">● SOCIAL_INSURANCE_NUMBER </p>
              <p class="block_182">● DRIVER_LICENSE_NUMBER </p>
              <p class="block_183">● NATIONAL_HEALTH_SERVICE_NUMBER </p>
              <p class="block_184">● SOCIAL_SECURITY_NUMBER </p>
              <p class="block_185">● PASSPORT </p>
              <p class="block_186">
              ...
              <p class="block_177">● MRN (medical record number) </p>
              <p class="block_189">
              ...
              <p class="block_191">● OHIP: Ontario Health Insurance Plan </p>
              <p class="block_192">
              ...
              <p class="block_199">● MEDICARE_NUMBER </p>
              <p class="block_200">
              ...
              <p class="block_211">Swift, Tom Hanks, Michael Jordan </p>
              <p class="block_212">Correct: Company or Business name, phone </p>
              <p class="block_213">number, or address. </p>
              <p class="block_214">Correct: Pet names </p>
              <p class="block_215">Correct: Social media handles </p>
            </div>
          </Paper>
        </Grid>
        <Hidden smDown>
