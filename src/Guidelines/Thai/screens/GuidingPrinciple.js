          ...
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <div id="aggreed-spelling">
                ...
                <p className={styles.block_16}>Spelling out</p>
                ...
                <p className={styles.block_20}>Interjections</p>
              ...
              <div id="punctuation">
                ...
                <p className={styles.block_74}>Spoken punctuation</p>
              ...
              <div id="format">
                ...
                <p className={styles.block_80}>Number</p>
                ...
                <p className={styles.block_110}>Date and time</p>
                ...
                <p className={styles.block_119}>Web</p>
                ...
                <p className={styles.block_130}>Abbreviation</p>
