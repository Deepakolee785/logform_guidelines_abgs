            ...
            <div className="content text">
              ...
              <div id="speaker-labeling">
                ...
                <p className={styles.block_147}>
                  ...
                  <span className={styles.text_2}>: speaker 1 </span>
                </p>
              ...
              <div id="pii">
                ...
                <p className={styles.block_160}>• CREDIT_CARD_NUMBER</p>
                <p className={styles.block_161}>• EMAIL</p>
                <p className={styles.block_162}>• PHONE_NUMBER</p>
                <p className={styles.block_163}>• SOCIAL_INSURANCE_NUMBER</p>
                <p className={styles.block_164}>• DRIVER_LICENSE_NUMBER</p>
                <p className={styles.block_165}>
                  • NATIONAL_HEALTH_SERVICE_NUMBER
                </p>
                <p className={styles.block_166}>• SOCIAL_SECURITY_NUMBER</p>
                <p className={styles.block_167}>• PASSPORT</p>
                ...
                <p className={styles.block_179}>• MEDICARE_NUMBER</p>
                ...
                <p className={styles.block_184}>• TAXPAYER_REFERENCE</p>
                <p className={styles.block_172}>
                ...
                <p className={styles.block_189}>
                  <span className={styles.text_2}>C</span>
                  <span className={styles.text_3}>ORRECT</span>
                  <span className={styles.text_2}>: Pet names </span>
                </p>
              </div>
            </div>
          </Paper>
