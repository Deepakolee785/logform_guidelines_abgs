          ...
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <p className={styles.block_398}>
                If a large number consists of only a number followed by "ল ", "ল
                কা ট", or higher, then transcribe as a numeral plus word.
              ...
              <p className={styles.block_408}>
                <span className={styles.text_11}>Example audio: " </span>
                <span className={styles.text_10}>শন এক ই পাচ সাত আট বার </span>
                <span className={styles.text_11}>" </span>
              </p>
              ...
              <p className={styles.block_424}>
                ...
                number. Only transcribe a "+" is the speaker says " াস".{' '}
              </p>
              ...
              <p className={styles.block_428}>
                <span className={styles.text_14}>Correct: 91 1234 123456 </span>
                <span className={styles.text_15}>
              ...
              <p className={styles.block_436}>Correct: Mercedes-Benz CLS450 </p>
              ...
              <p className={styles.block_440}>Currency and unit </p>
              <p className={styles.block_441}>
                Transcribe currencies with the "৳" symbol followed by digits. Do
                not include a space between the symbol and the number.{' '}
              </p>
              ...
              <p className={styles.block_448}>
                Explanation: "ইউেরা" refers to a foreign currency.{' '}
              </p>
              <p className={styles.block_449}>
                Transcribe the numbers as digits "300" and write out the{' '}
              </p>
              <p className={styles.block_450}>
                word "ইউেরা". Don't use the euro symbol.{' '}
              </p>
              ...
              <p className={styles.block_487}>Date and time </p>
              ...
              <p className={styles.block_489}>
                <span className={styles.text_6}>Correct: 12ই জ লাই 1964 </span>
                <span className={styles.text_7}>Example audio: " </span>
              ...
              <p className={styles.block_490}>
                ...
                <span className={styles.text_7}>Example audio: " </span>
                <span className={styles.text_8}>পেহলা জানয়াির বহ িতবার </span>
                <span className={styles.text_7}>" </span>
              </p>
              ...
              <p className={styles.block_499}>Address </p>
              ...
              <p className={styles.block_506}>Web </p>
              ...
              <p className={styles.block_516}>
                <span className={styles.text_22}>Example </span>
              ...
              <p className={styles.block_517}>
                ...
                <span className={styles.text_10}>
                  ডাি উ ডাি উ ডট েগাল ডট িস ও ডট ক{' '}
                </span>
              </p>
              <p className={styles.block_518}>
                <span className={styles.text_8}>আর </span>
                <span className={styles.text_7}>" </span>
              ...
              <p className={styles.block_520}>Abbreviation </p>
