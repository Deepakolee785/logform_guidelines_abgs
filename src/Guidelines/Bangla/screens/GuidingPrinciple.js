        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.block_}>Transcription guiding principles </p>
              ...
              <p className={styles.block_2}>Difficult utterances </p>
              ...
              <p className={styles.block_15}>Agreed spelling </p>
              ...
              <p className={styles.block_50}>Punctuation </p>
              ...
              <p className={styles.block_77}>Format </p>
              ...
              <p className={styles.block_97}>
                <span className={styles.text_}>○ </span>
                <span className={styles.text_1}>Example Audio: </span>
                <span className={styles.text_}>season three episode two </span>
              </p>
              ...
              <p className={styles.block_113}>
                <span className={styles.text_}>○ </span>
                <span className={styles.text_1}>Example Audio: </span>
                <span className={styles.text_}>a few minutes after three </span>
              </p>
              <p className={styles.block_114}>
                <span className={styles.text_}>○ </span>
                <span className={styles.text_1}>Correct: </span>
                <span className={styles.text_}>a few minutes after 3:00 </span>
              </p>
              ...
              <p className={styles.block_119}>
                <span className={styles.text_}>○ </span>
                <span className={styles.text_1}>Correct: </span>
                <span className={styles.text_}>McDonald's, Castro Street </span>
              </p>
