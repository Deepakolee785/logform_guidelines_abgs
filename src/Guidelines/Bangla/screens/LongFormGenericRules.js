        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              <p className={styles.block_137}>Longform generic rules </p>
              ...
              <p className={styles.block_143}>Segmentation </p>
              ...
              <p className={styles.block_147}>Speaker labeling </p>
              ...
              <p className={styles.block_149}>Correct: speaker 1 </p>
              ...
              <p className={styles.block_158}>Audio labels </p>
              ...
              <p className={styles.block_172}>Pii </p>
              ...
              <p className={styles.block_177}>● CREDIT_CARD_NUMBER </p>
              <p className={styles.block_178}>● EMAIL </p>
              <p className={styles.block_179}>● PHONE_NUMBER </p>
              <p className={styles.block_180}>● SOCIAL_INSURANCE_NUMBER </p>
              <p className={styles.block_181}>● DRIVER_LICENSE_NUMBER </p>
              <p className={styles.block_182}>
                ● NATIONAL_HEALTH_SERVICE_NUMBER{' '}
              </p>
              <p className={styles.block_183}>● SOCIAL_SECURITY_NUMBER </p>
              <p className={styles.block_184}>● PASSPORT </p>
              ...
              <p className={styles.block_187}>● MRN (medical record number) </p>
              ...
              <p className={styles.block_198}>● MEDICARE_NUMBER </p>
              ...
              <p className={styles.block_204}>● FDA_CODE: Prescription drug </p>
              ...
              <p className={styles.block_206}>● TAXPAYER_REFERENCE </p>
              ...
              <p className={styles.block_212}>number, or address. </p>
              <p className={styles.block_213}>Correct: Pet names </p>
              <p className={styles.block_214}>Correct: Social media handles </p>
            </div>
          </Paper>
        </Grid>
        <Hidden smDown>
