          ...
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <div id="punctuation">
                ...
                <p className={styles.block_51}>Fragments versus sentences</p>
                ...
                <p className={styles.block_54}>Commas</p>
                ...
                <p className={styles.block_56}>Colon and quotation</p>
                ...
                <p className={styles.block_65}>Other symbols</p>
              ...
              <div id="format">
                ...
                <p className={styles.block_101}>Currency and unit</p>
                ...
                <p className={styles.block_108}>Date and time</p>
                ...
                <p className={styles.block_112}>Address</p>
                ...
                <p className={styles.block_116}>Web</p>
                ...
                <p className={styles.block_129}>Abbreviation</p>
