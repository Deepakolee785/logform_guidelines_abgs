        ...
        <Grid sm={12} md={9} item>
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <p className={styles.block_498}>Տ, Ր, Ց, Ւ, Փ, Ք, եւ, Օ եւ Ֆ </p>
              ...
              <p className={styles.block_503}>Interjections </p>
              ...
              <p className={styles.block_510}>Explanation: Երեքից ավել վանկ </p>
              <p className={styles.block_511}>չտառադարձե՛լ։ </p>
              <p className={styles.block_512}>Proper names </p>
              ...
              <p className={styles.block_515}>Correct: Զանգահարի՛ Մարիամին։ </p>
              ...
              <p className={styles.block_521}>
                <span className={styles.text_8}>Correct: Սոֆիա Մաքդոնալդ </span>
              ...
              <p className={styles.block_529}>Brand and product </p>
              ...
              <p className={styles.block_546}>Correct: Ok Google, դդումներ </p>
              ...
              <p className={styles.block_550}>Media title </p>
              ...
              <p className={styles.block_555}>Multiple spellings </p>
              ...
              <p className={styles.block_565}>Incorrect: Նա սուրճ է սիրում։ </p>
