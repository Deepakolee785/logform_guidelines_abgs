          ...
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <p className={styles.block_584}>
                <span className={styles.text_17}>Correct: ավելի մեծ քան </span>
              ...
              <p className={styles.block_590}>
                <span className={styles.text_17}>Correct: շոկոլադե սալիկ </span>
                <span className={styles.text_6}>Example audio: " </span>
              ...
              <p className={styles.block_604}>Correct: Do you like it? Mhm. </p>
              ...
              <p className={styles.block_615}>
                Explanation: Խոսողն ասում է «խաց» հացի փոխարեն: Տառադարձե՛լ ճիշտ
                տարբերակով։
              </p>
