          ...
          <Paper className={classes.content}>
            ...
            <div className="content text">
              ...
              <div id="punctuation">
                ...
                <p className={styles.block_55}>Commas </p>
                ...
                <p className={styles.block_57}>Colon and quotation </p>
                ...
                <p className={styles.block_66}>Other symbols </p>
              ...
              <div id="format">
                ...
                <p className={'text'}>
                  Transcribe numbers, abbreviations et c. following the
                ...
                <p className={styles.block_103}>Currency and unit </p>
                ...
                <p className={styles.block_116}>Address </p>
                ...
                <p className={styles.block_120}>Web </p>
