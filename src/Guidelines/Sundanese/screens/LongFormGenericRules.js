            ...
            <div className="content text">
              ...
              <div id="speaker-labeling">
                ...
                <p className={styles.block_150}>
                  <span className={styles.text_}>Correct: speaker</span>
                  <span className={styles.text_}>1 </span>
                </p>
                <p className={styles.block_151}>Incorrect: Speaker 1</p>
              ...
              <div id="pii">
                ...
                <p className={styles.block_179}>● CREDIT_CARD_NUMBER</p>
                <p className={styles.block_180}>● EMAIL</p>
                <p className={styles.block_181}>● PHONE_NUMBER</p>
                <p className={styles.block_182}>● SOCIAL_INSURANCE_NUMBER</p>
                <p className={styles.block_183}>● DRIVER_LICENSE_NUMBER</p>
                <p className={styles.block_184}>
                  ● NATIONAL_HEALTH_SERVICE_NUMBER
                </p>
                <p className={styles.block_185}>● SOCIAL_SECURITY_NUMBER</p>
                <p className={styles.block_186}>● PASSPORT</p>
                ...
                <p className={styles.block_200}>● MEDICARE_NUMBER</p>
                ...
                <p className={styles.block_208}>● TAXPAYER_REFERENCE</p>
                ...
                <p className={styles.block_214}>number, or address.</p>
                <p className={styles.block_215}>Correct: Pet names</p>
